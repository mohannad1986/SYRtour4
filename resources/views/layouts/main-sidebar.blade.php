            ...
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu item chat-->
                      ...
                      <li>
                        <a href="{{route('city.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text">{{ trans('sidebar.cities') }}
                               </span> </a>
                    </li>

                    <li>
                        <a href="{{route('town.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text">{{ trans('sidebar.towns') }}

                               </span> </a>
                    </li>

                    <li>
                        <a href="{{route('category.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text"> {{ trans('sidebar.categories') }}
                               </span> </a>
                    </li>

                    <li>
                        <a href="{{route('cits_categories_index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text"> {{ trans('sidebar.cities & categories') }}
                               </span> </a>
                    </li>

                    <li>
                        <a href="{{route('facility.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text"> {{ trans('sidebar.Facilities') }}
                    </li>
                 ...
                 {{-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ --}}
                        @if(auth('owner')->check())
                                ...
                                @if (isset( auth()->guard('owner')->user()->facility->id))
                                <li>

                                    <?php  $idfacility= auth()->guard('owner')->user()->facility->id;   ?>
                                    <a href="{{route('facility.show',$idfacility)}}"><i class="ti-menu-alt"></i><span class="right-nav-text">منشأتي
                                 ...
                                 @if (!isset( auth()->guard('owner')->user()->facility->id))
                                    <li>
                                        ...
                                        <a href="{{route('facility.index')}}"><i class="ti-menu-alt"></i><span class="right-nav-text"> اضافة منشأة
                                    </li>
                                @endif
