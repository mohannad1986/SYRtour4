                          ...
                          <div class="slide">
                            <div class="slide-content">
                              <div class="caption">
                                ...
                                <?php   $categotiies=$city->categories ?>
                                 @foreach ($categotiies as $category )
                                        <a href="{{route('descover_fac',['city_id'=>$city->id,'category_id'=>$category->id]);}}" class="btn">
                                            <span class="btn-inner">{{$category->name}}</span>
                                        </a>
                            ...
                            <div class="image-container">
                              ...
                              <img src="{{Storage::url('public/city/'.$city->images->filename.'')}}"alt="" class="image" />
                            </div>
