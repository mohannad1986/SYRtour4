                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> {{trans('city.cities')}}
                            </p>
                        </a>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    ...
                                    <h4>{{ App\Models\Town::count(); }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-bookmark-o mr-1" aria-hidden="true"></i> {{trans('town.towns')}}
                            </p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-calendar mr-1" aria-hidden="true"></i> {{trans('category.category')}}
                            </p>
                        </a>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    ...
                                    <h4>{{ App\Models\facility::count(); }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-repeat mr-1" aria-hidden="true"></i> {{trans('facility.facilities')}}
                            </p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-repeat mr-1" aria-hidden="true"></i> {{trans('tourist.tourists')}}
                            </p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    {{-- <p class="card-text text-dark">Followers</p> --}}
                                    <h4>{{ App\Models\Owner::count(); }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-repeat mr-1" aria-hidden="true"></i> {{trans('tourist.owners')}}
                            </p>
                            </a>
                        </div>
                    </div>
